-- =====================================================================
-- MIGRATION 003: Add stock movement and damage history tables
--
-- This migration closes the stock-history gap by persisting:
--   - allocation requests and approvals
--   - frame transfers between branches
--   - damage reports and owner approvals
--
-- It also backfills the current stock_distribution and damaged_stock data
-- so the UI can show history immediately after the migration runs.
-- =====================================================================
